 ...
 *  ряда компактных чипов (счёт/цели + жизни/кнопки, ниже — рекорд/серия/
 *  монеты/щит). Запас покрывает перенос одного чипа на следующую строку. */
export const HUD_TOP_PORTRAIT_CSS = 140
