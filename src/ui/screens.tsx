                        ...
                        {[
                          {
                            ...
                            hint: "ЛКМ/ПКМ удержание = ±30°, ускорение мяча (взаимоисключает Импульсный удар и Выпуклую ракетку)",
                          },
                          {
                            id: "paddleImpulse",
                            label: "⚡ Импульсный удар",
                            hint: "ЛКМ/ПКМ клик = резкий доворот и возврат (взаимоисключает Поворот ракетки и Выпуклую ракетку)",
                          },
                          {
                            id: "paddleConvex",
                            label: "∩ Выпуклая ракетка",
                            hint: "Купол: мяч отскакивает веером по нормали дуги (взаимоисключает Поворот ракетки и Импульсный удар)",
                          },
                        ].map((e) => (
                          <label
                            key={e.id}
